...
from views import create_customer, delete_animal, delete_location
from views import delete_employee, delete_customer
from views import update_animal, update_location, update_customer, update_employee, get_customers_by_email, get_animals_by_location_id
from urllib.parse import urlparse, parse_qs
from views import get_employees_by_location_id, get_animals_by_status
